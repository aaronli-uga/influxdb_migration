...
def get_arguments():
    parser = argparse.ArgumentParser(description="Migrate data from one influxDB database to another.\r \
                                    \nFor example: \
                                    ...
                                    , please open browser with user/password:guest/sensorweb_guest to see the result at grafana: https://grafana.sensorweb.us/d/L3IBhqdGz/migration-example?orgId=1&from=1596842552000&to=1596842555002 \
                                    ")
